...
cnoremap b <S-Left>
cnoremap f <S-Right>
cnoreabbr as AsyncStop
cnoreabbr a AsyncRun
cnoreabbr f Leaderf
let &cpo=s:cpo_save
unlet s:cpo_save
set autoindent
...
set pyxversion=3
set ruler
set runtimepath=~/.vim,~/.vim/pack/plugins/start/vim-gitgutter,~/.vim/pack/plugins/start/lightline,~/.vim/pack/plugins/start/coc.nvim,~/.vim/pack/plugins/start/auto-pairs,~/.vim/pack/plugins/start/asynctasks.vim,~/.vim/pack/plugins/start/asyncrun.vim,~/.vim/pack/plugins/start/LeaderF,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,~/.vim/after,~/.config/coc/extensions/node_modules/coc-snippets
set showmatch
set noshowmode
set smartcase
set softtabstop=2
